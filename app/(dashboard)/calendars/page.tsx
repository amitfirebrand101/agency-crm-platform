  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">Manage booking calendars and appointment inventory per sub account.</p>
      </div>
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_22rem]">
        ...
        <Card>
          <CardHeader><div className="flex items-center gap-2"><Plus className="text-primary" size={18} /><h2 className="font-semibold">New calendar</h2></div></CardHeader>
          <CardBody>
            <form action={createCalendar} className="space-y-3">
              <Field label="Name" name="name" placeholder="Sales calls" required />
              <button className="w-full rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white" type="submit">Create calendar</button>
            </form>
          </CardBody>
        </Card>
      </section>
